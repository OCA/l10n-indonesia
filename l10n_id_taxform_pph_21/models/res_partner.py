    ...
    def compute_pph_21_2110001(
        ...
        if not ptkp_category:
            raise models.ValidationError(
                _("Partner's PTKP Category is not configured")  # noqa
            )  # noqa
        ...
        pengurang = biaya_jabatan_rutin + biaya_jabatan_non_rutin + pensiun
        netto_rutin = jumlah_penghasilan_rutin - biaya_jabatan_rutin - pensiun
        netto_non_rutin = jumlah_penghasilan_non_rutin - biaya_jabatan_non_rutin
