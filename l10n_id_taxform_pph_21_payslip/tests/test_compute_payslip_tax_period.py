...
class TestComputePayslipTaxPeriod(TransactionCase):
    def setUp(self, *args, **kwargs):
        ...
        self.rule_1 = self.env.ref("payroll.hr_salary_rule_houserentallowance1")
        self.rule_2 = self.env.ref("payroll.hr_salary_rule_convanceallowance1")
        self.rule_3 = self.env.ref("payroll.hr_salary_rule_professionaltax1")
